...
https://travis-ci.com/saltstack-formulas/lynis-formula[image:https://travis-ci.com/saltstack-formulas/lynis-formula.svg?branch=master[Travis CI Build Status]]
...
Installs the Lynis profiles defined in pillar in Lynis configuration
directory.
...
Creates the docker instance and runs the `lynis` main state, ready for
testing.
